...
from fairseq.models.nat.nat import NATransformerModel, base_architecture
...
class NACRFTransformerModel(NATransformerModel):
    ...
    def forward(
        self, src_tokens, src_lengths, prev_output_tokens, tgt_tokens, train_ratio=None, reduce=True, **kwargs
    ):
        # encoding
